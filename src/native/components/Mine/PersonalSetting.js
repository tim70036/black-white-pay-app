...
class PersonalSetting extends React.Component {
  ...
  getDataList = () => {
    return (
      [
        [
          { key: 1, title: '更改暱稱', subtitle: '', image: require('../../../img/mine/icon_navigation_item_set_white.png'), handle: ()=>{Actions.changeName()} },
          { key: 2, title: '更改密碼', subtitle: '', image: require('../../../img/mine/icon_navigation_item_set_white.png'), handle: ()=>{Actions.changePwd()} },
          { key: 3, title: '更改交易密碼', subtitle: '', image: require('../../../img/mine/icon_navigation_item_set_white.png'), handle: ()=>{Actions.changeTransPwd()} },
        ],
      ]
    );
  }
