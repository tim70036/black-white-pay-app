...
（包括境內及境外）、或移作蒐集目的以外之使用。在合約有效期間內，以及法令所定應保存之期間內，\
本公司會持續保管、處理及利用相關資料。'}
          </Text>
          <View style={{ height: 15 }} />
...
團體、私人企業或公務機關，但有法律依據或合約義務者，不在此限。前項但書之情形包括不限於：
  •經由您書面同意。
  • 法律明文規定。
  • 為免除您生命、身體、自由或財產上之危險。
  ...
  • 有利於您的權益。`}
          ...
          <View style={{ height: 15 }} />
          <Text style={styles.text}>
            {'本公司有權隨時修訂本隱私權聲明及相關告知事項，並得於修訂後公佈在本APP上之適當位置，\
不另行個別通知，您可以隨時在本APP上詳閱修訂後的隱私權聲明及相關告知事項。'}
          </Text>
